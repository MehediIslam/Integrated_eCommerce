...
class EmployeeProfileList extends JInternalFrame implements ActionListener {
	...
	public EmployeeProfileList() {
		super("Employee List", true, true, true, true);
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (command.equals("Deactive")) {
			i = table.getSelectedRow();
			int selectedRow = table.getSelectedRow();
			if (selectedRow != -1) {

				Integer uid = Integer.parseInt(tableModel.getValueAt(i, 0)
						.toString());
				...
				if (type_id == 100) {
					this.tableModel.setValueAt("deactive", i, 7);
				}
		...
		if (command.equals("Active")) {
			...
			if (selectedRow != -1) {
				...
				int type_id = typeAdapter.getUserType(sess_id);
				if (type_id == 100) {
					this.tableModel.setValueAt("active", i, 7);
				}
	...
	public void InitializeComponents() {
		...
		this.tableModel = new DefaultTableModel(adapter.EmployeeList(), columns);
		...
		this.buttonDeactivate = new JButton("Active");
		this.buttonDeactivate.setBounds(330, 310, 90, 20);
		this.buttonDeactivate.addActionListener(this);
		this.panel.add(this.buttonDeactivate);

		this.buttonDeactivate = new JButton("Deactive");
		this.buttonDeactivate.setBounds(420, 310, 90, 20);
		this.buttonDeactivate.addActionListener(this);
		this.panel.add(this.buttonDeactivate);
